...
export default function TeamSection() {
	...
	const speakers = [
		...
		{ name: 'Dr. Hartland Jackson', city: 'Ontario, Canada', image: "/team-members/Hartland.png", role: 'Assistant Professor Lunenfeld-Tanenbaum Research Institute, Toronto | Canada Research Chair (Tier II) in Systems Pathology ', desc: "Dr Hartland Jackson is a cancer biologist whose research pioneers the use of highly multiplexed mass spectrometry imaging, integrated with advanced computational methods, to analyze spatially resolved single cell data within the complex tumour environment. His approach enables the screening of distinct cellular clones in murine disease models and has contributed to the identification of biomarkers associated with clinical outcome in human tissues. Dr. Jackson’s lab work is transforming our understanding of the tumour microenvironment, revealing single-cell defined patient subgroups with distinct prognoses and uncovering the multicellular interactions that drive disease progression.", linkedin: 'https://www.linkedin.com/in/hartlandjackson/' },
		...
		{ name: 'Dr. Ashleigh Willis', city: 'British Columbia, Canada', image: "/team-members/ashleigh.png", role: "Postdoctoral fellow and PANORAMICS - A vision's executive team member", desc: 'Dr. Ashleigh Willis is a neuroscientist studying how forebrain neural stem cells respond to injury and how their microenvironment guides their activation, fate and regenerative potential. Her research combines single cell sequencing and spatial transcriptomics with murine in vivo models of injury and disease to uncover how endogenous neural stem cells might be harnessed to repair the brain. As a Program Director of True North Spatial 2026, Dr. Willis is curating a contemporary, unconventional program which brings together innovators in single cell and spatial biology while creating meaningful training opportunities for early career scientists. During the summit, Dr. Willis will spotlight the vision behind Panoramic - A Vision’s “Enlighten Me” chapter. ', linkedin: 'https://www.linkedin.com/in/ashleigh-willis-06a724142/' },
	];
	...
	const organizers = [
		...
		{ name: 'Arzu Kirici', image: "/team-members/arzu-kirici.jpg", role: ' Computational Biologist', desc: 'Computational Biologist with a molecular biology background, focusing on spatial analysis and developing software. ', linkedin: 'https://www.linkedin.com/in/arzu-kirici/' },
		...
		{ name: 'Kasra Rahimian', image: "/team-members/kasra-rahimian.jpg", role: 'Software Developer', desc: "Software developer and designer with a multidisciplinary background in digital solutions, research support, and engineering. Currently focused on bringing Panoramics' web app to life while exploring creative side projects.", linkedin: 'https://www.linkedin.com/in/kasrarahimian/' },
		{ name: 'Smrithi Dhanasekar', image: "/team-members/Smrithi.jpeg", role: ' Specializing in creating impactful content', desc: 'Focus on 3D perception and simulation for robotics.', linkedin: 'https://www.linkedin.com/in/smrithi-dhanasekar/' },
