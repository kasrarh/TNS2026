...
export default function TeamSection() {
	...
	const speakers = [
		{ name: 'Dr. Morag Park', image: "/team-members/morag-park.jpg", role: 'Director at Goodman Cancer research Centre', desc: "Professor Morag Park’s research focuses on understanding how deregulated activation of growth factor receptors, particularly the Met receptor tyrosine kinase, contributes to cancer progression. His work explores how Met, which normally promotes tissue organization, becomes altered in tumor cells to enhance invasion and metastasis. By using Met as a model system, his lab aims to identify key signaling pathways involved in cancer development and uncover therapeutic strategies to target these mechanisms driving cell transformation, invasion, and tumorigenesis.", linkedin: 'https://www.linkedin.com/in/morag-park-169084136/' },
		...
		{ name: 'Dr. Garry Nolan', image: "/team-members/garry-nolan.jpg", role: 'Life Sciences, Bioinformatics', desc: "Dr. Garry Nolan's research in the last several years has established that it is possible to analyze with considerable resolution cellular events at the single cell level in human patient samples or in primary cells from animal models.  Our efforts have been focused on understanding kinase-based signaling networks in normal and diseased cells.   We have examined the pathological disturbances in the immune system, like autoimmunity,  and cancer. In parallel,   we study  normal immune activation and differentiation events in hematopoiesis .", linkedin: 'https://www.linkedin.com/in/garry-nolan-0b4315/' },
		{ name: 'Dr. Freda Miller', image: "/team-members/freda-miller.png", role: 'Deputy Director, Professor', desc: "Dr. Miller joins UBC from the Hospital for Sick Children in Toronto, where she was a Senior Scientist and Professor at the University of Toronto. She is a Fellow of the Royal Society of Canada and of the American Association for the Advancement of Science and at the Hospital for Sick Children she was a Howard Hughes Medical Institute International Research Scholar and the Canada Research Chair in Developmental Neurobiology. Most recently, Dr. Miller’s accomplishments were recognized by the naming of the “Dr. Freda Miller” public school by the Calgary Board of Education.", linkedin: 'https://www.msl.ubc.ca/people/dr-freda-miller/' },
		{ name: 'Dr. Jeffrey Biernaskie', image: "/team-members/jeff-biernaskie.jpg", role: 'Professor, Faculty of Veterinary Medicine & Dept of Surgery, Cumming School of MedicineUniversity of Calgary |  Co-Founder & Scientific Lead, FibroDynamx', desc: "Dr. Jeffrey Biernaskie's research program is focused on understanding the cellular and molecular mechanisms that promote fibrotic versus regenerative healing with the goal of developing treatments to restore healthy organ function following injury or disease. We are also interested in how skin and brain stem/progenitor cells are regulated during homeostasis and how factors like injury, advanced aging and the immune system impact their function.", linkedin: 'https://www.linkedin.com/in/jeff-biernaskie-29b04940/' },
