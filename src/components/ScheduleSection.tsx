	...
	const scheduleData: Record<string, ScheduleSession[]> = {
		day1: [
			...
			},
			{
				...
				sponsor: "Supported by Miltenyi Biotec (Connectome Sponsor)",
			...
			},
			{
				...
				chapter:'"Challenge-me" Talk',
				sponsor: "Supported by Bio-techne",
			...
			},
			{
				...
				chapter:'"Enlighten-me" Talk',
				sponsor: "Supported by Stellaromics",
			...
			},
			{
				...
				chapter:'"Inspire-me" Talk',
				sponsor: "Supported by 10x Genomics",
		...
		day2: [
			...
			},
			{
				...
				chapter:'"Enlighten-me" Talk',
				sponsor: "Supported by Complete Genomics & DMark Biocsiences",
		...
		day3: [
			...
			},
			{
				...
				chapter:'"Enlighten-me" Talk',
				sponsor: "Supported by Element Biosciences",
			...
			
			{
				...
				chapter:'"Enlighten-me" Talk',
				sponsor: "Supported by Leica Microsystems",
