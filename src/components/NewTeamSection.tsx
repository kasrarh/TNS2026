...
const speakers: Person[] = [
  ...
  { name: 'Ms. Alyona Ivanova', city: 'Ontario, Canada', image: "/team-members/Alyona.jpg", role: 'Doctoral Student at University of Toronto Graduate Student Researcher at the Brain Tumour Research Centre, The Hospital for Sick Children', desc: "Alyona Ivanova joined Panoramics in 2024 as Creative Content Manager, where she leads the development of scientifically grounded content that engages and informs the spatial and single-cell biology community. In parallel, Alyona is a PhD candidate in Medical Sciences at the University of Toronto, researching novel strategies to overcome chemo-resistance in glioblastoma at the Hospital for Sick Children, working at the interface of translational research and clinical care.", linkedin: 'https://www.linkedin.com/in/alyona-ivanova-skate22/' },
...
const organizers: Person[] = [
  ...
  { name: 'Suluxan Mohanraj', image: "/team-members/suluxan.JPG", shortRole: 'Web development Executive', role: 'Web development Executive | TNS2026\nAI & Technology Innovation Officer | Panoramics - A Vision', desc: 'Involved in identifying emerging technologies, streamlining data accessibility, and building platforms that empower researchers to unlock new insights in bioinformatics.', linkedin: 'https://www.linkedin.com/in/suluxan/' },
	...
	{ name: 'Arzu Kirici', image: "/team-members/arzu-kirici.jpg", shortRole: 'Marketing & Administrative Executive', role: 'Marketing & Administrative Executive | TNS2026\nData Analyst | Panoramics - A Vision', desc: 'Computational Biologist with a molecular biology background, focusing on spatial analysis and developing software. ', linkedin: 'https://www.linkedin.com/in/arzu-kirici/' },
