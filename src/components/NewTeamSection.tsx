...
const speakers: Person[] = [
  { name: 'Dr. Shamini Ayyadhury', city: 'Ontario, Canada', image: "/team-members/shamini.JPEG", role: 'Founder, CEO of Panoramics - A Vision Inc | Scientific Associate, UHN', desc: 'Dr. Shamini Ayyadhury is a computational biologist who works at the cutting edge of single cell and spatial biology, her work encompasses a deep understanding of analysis methods, machine learning and deep biological insight. As founder and CEO of Panoramics - A Vision Inc, she leads a pan-Canadian effort that unites computational, experimental and clinical expertise in the single cell and spatial biology community. As summit chair, her leadership and vision are at the heart of True North Spatial 2026, where she initiated the idea and has shaped a program that brings innovators together to push the boundaries of the field.', linkedin: 'https://www.linkedin.com/in/sayyadhury/' },
	...
	{ name: 'Dr. Jasmine Plummer', city: 'Tennessee, USA', image: "/team-members/JasminePlummer.jpg", role: 'Director, Center for Spatial OMICs, St. Jude Children’s Research Hospital Associate Member, St. Jude Faculty', desc: "Dr. Jasmine Plummer is the Director of the Center for Spatial OMICs at St. Jude Children’s Research Hospital and an Associate Member of the St. Jude Faculty. Her research uses genomic and spatial technologies to understand how genetics, epigenomics, cell type-specific pathogenesis, and spatial context contribute to disease, with a focus on diverse populations. She is also a co-founder of GESTALT, the Global Alliance for Spatial Technologies.", linkedin: 'https://www.linkedin.com/in/jasmine-plummer-28248360/' },
  ...
  { name: 'Dr. Paul Robson', city: 'Connecticut, USA', image: "/team-members/paul-robson.png", role: 'Professor, The Jackson Laboratory for Genomic Medicine', desc: null, linkedin: "https://www.linkedin.com/in/paulrobson4/" },
  { name: 'Dr. Shreejoy Tripathy', city: 'Ontario, Canada', image: "/team-members/Shreejoy-Tripathy.jpg", role: 'Scientist, Krembil Centre for Neuroinformatics, Centre for Addiction and Mental Health (CAMH) | Assistant professor, Department of Psychiatry, University of Toronto.', desc: null, linkedin: "https://www.linkedin.com/in/shreejoy-tripathy-05755636/" },
  { name: 'Dr. Sabrina Leslie', city: 'British Columbia, Canada', image: "/team-members/Sabrina-Leslie.jpg", role: 'Associate Professor - Faculty of Science, Michael Smith Laboratories, UBC', desc: null, linkedin: "https://www.linkedin.com/in/sabrina-leslie-68bb46a3/" },
  { name: 'Dr. Derek Newton', city: 'Ontario, Canada', image: "/team-members/Derek headshot Mitacs.jpeg", role: 'Senior Vice-President, Business Development and Strategy', desc: null, linkedin: "https://www.linkedin.com/in/derek-newton-6383177/" },
  { name: 'Dr. Elvin de Araujo', city: 'Ontario, Canada', image: "/team-members/Elvin.png", role: 'Research Manager at University of Toronto', desc: null, linkedin: "https://www.linkedin.com/in/elvin-de-araujo/" },
  { name: 'Dr. Tallulah Andrews', city: 'Ontario, Canada', image: "/team-members/TallulahAndrews.png", role: 'Assistant Professor, Biochemistry, University of Western Ontario', desc: null, linkedin: "https://www.linkedin.com/in/tallulah-andrews-60169122/" },
  { name: 'Dr. Giselle B.', city: 'Ontario, Canada', image: "/team-members/GiselleB.png", role: 'Scientific Associate at Princess Margaret Cancer Centre Research', desc: null, linkedin: "https://www.linkedin.com/in/giselle-b-0497852a6/" },
  { name: 'Nia Hughes', city: 'Ontario, Canada', image: "/team-members/NiaHughes.png", role: 'Platform Training Manager at the Canadian Bioinformatics Hub', desc: null, linkedin: "https://www.linkedin.com/in/hughesnia/" },
  ...
  //Add isSponsored: true for sponsored speakers and update the CSS to show the badge on the tile and in the modal
	{ name: 'Daphne Sze', city: 'Massachusetts, USA', image: "/team-members/DaphneSze.png", role: "Biomedical Engineer at Stellaromics Inc",  linkedin: 'https://www.linkedin.com/in/daphnesze/' },
	{ name: 'Dr. Rick Heil-Chapdelaine', city: 'Missouri, USA', image: "/team-members/Rick_C.jpg", role: "Spatial Biology Specialist at Leica Microsystems",  linkedin: 'https://www.linkedin.com/in/rick-heil-chapdelaine-807a5a10/' },
	{ name: 'Dr. John Gillespie', city: 'Massachusetts, USA', image: "/team-members/JohnG.png", role: "President and CEO, AmberGen",  linkedin: 'https://www.linkedin.com/in/johngillespie1/' },
	{ name: 'Dr. Troy Ketela', city: 'Ontario, Canada', image: "/team-members/TroyKetela.jpg", role: "Staff Scientist III, UHN,Head Of Operations - Princess Margaret Genomics Centre",  linkedin: 'https://www.linkedin.com/in/troy-ketela-60229363/' },
	{ name: 'Dr. Michael Smith', city: 'Connecticut, USA', image: "/team-members/MichaelSmith.png", role: "Regional Commercial Lead, Single Cell and Spatial Technologies at illumina",  linkedin: 'https://www.linkedin.com/in/michaelgarrettsmith/' },
	{ name: 'Dr. Oliver Braubach', city: 'Nevada, USA', image: "/team-members/OliverB.png", role: "Senior Director of Research and Development at Bruker Spatial Biology",  linkedin: 'https://www.linkedin.com/in/oliver-braubach/' },
	{ name: 'Dr. Sayak M.', city: 'Illinois, USA', image: "/team-members/SayakM.png", role: "Sr. FAS & Team Supervisor at Vizgen",  linkedin: 'https://www.linkedin.com/in/sayak-m-05566755/' },
	{ name: 'Rami Mechael', city: 'Ontario, Canada', image: "/team-members/RamiMechael.png", role: "Sales Executive at 10x Genomics",  linkedin: 'https://www.linkedin.com/in/rami-mechael-85540065/' },
	{ name: 'Sarah Goodwin', city: 'Michigan, USA', image: "/team-members/Sarah_Goodwin.jpg", role: "Account Manager at Novogene",  linkedin: 'https://www.linkedin.com/in/sarah-goodwin-5b5184153/' },
	{ name: 'Dr. Kieran Campbell', city: 'Ontario, Canada', image: "/team-members/KieranCampbell.png", role: "Research Group Leader",  linkedin: 'https://www.linkedin.com/in/kieranrcampbell/' },
	{ name: 'Dr. Yongfu Wang', city: 'Kansas, USA', image: "/team-members/YongfuWang.png", role: "Head of Sales at Spatial Genomics",  linkedin: 'https://www.linkedin.com/in/yongfu-wang-76141b43/' },
	{ name: 'Dr. Victor Mullins-Dansereau', city: 'Quebec, Canada', image: "/team-members/Victor Mullins-Dansereau.png", role: "Teaching Assistant ⏐ MCB3004 - Experimental Protocol in Vaccinology, University de Montreal",  linkedin: 'https://www.linkedin.com/in/victormullinsdansereau/' },
	{ name: 'Dr. Connor West', city: 'North Carolina, USA', image: "/team-members/ConnorWest.png", role: "Field Application Specialist at Lunaphore",  linkedin: 'https://www.linkedin.com/in/connorwest315/' },
